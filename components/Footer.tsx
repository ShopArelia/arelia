...
export default function Footer() {
    return (
        <div className="w-full flex flex-col px-8 md:px-16 py-6 gap-6 bg-surface-400">
            <div className="w-full flex flex-col md:flex-row gap-12">

                <div className="w-full flex md:flex-col justify-center gap-3">
                    ...
                    <p className="text-body-sm text-surface-200 font-DMSans-400 hidden md:block">A marketplace where every purchase supports a verified nonprofit. Shop with purpose.</p>
                    <div className="flex gap-3">
                        {/* MaskedIcon renders aria-hidden, so an icon-only link has no
                            accessible name unless the anchor carries one itself. */}
                        <Link href="https://www.instagram.com/areliaforgood" target="_blank" rel="noopener noreferrer" aria-label="Arelia on Instagram" className="w-[36px] h-[36px] flex items-center justify-center border-2 rounded-md border-surface-300">
                            <MaskedIcon src="/icons/instagram.svg" size="24px" className="text-primary-200" />
                        </Link>
                        {/* <Link href="https://www.x.com" target="_blank" rel="noopener noreferrer" aria-label="Arelia on X" className="w-[36px] h-[36px] flex items-center justify-center border-2 rounded-md border-surface-300">
